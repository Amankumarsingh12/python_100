...
def reset_timer():
    ...
    title_lable.config(text="Timmer")
...
def count_down(count):
    ...
    if count > 0:
        global timmer
        timmer = window.after(100, count_down, count - 1)
    else:
        start_timer()
        mark = ""
...
title_lable = tkinter.Label(text="Timer", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 50))
...
check_mark = tkinter.Label( fg=GREEN, bg=YELLOW, font=(FONT_NAME, 25))
